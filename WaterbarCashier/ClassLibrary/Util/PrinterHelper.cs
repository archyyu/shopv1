...
namespace CashierLibrary.Util
{
    ...
    public class PrinterHelper
    {
        ...
        private static Byte[] Const_OpenCashBox = new byte[] { 0x1B, 0x70, 0x00, 0x80, 0xFF };
        ...
        #region 公开函数
        private static PrinterHelper m_instance = new PrinterHelper();
        ...
        public Boolean PrintText(String content)
        {
            ...
            DataFormatProcessor.StringToBytes(content, out bytes);
        ...
        public bool OpenCashBox()
        {
            ...
            bool b1 = SendCommand(Const_OpenCashBox);
            return b1;
        }
